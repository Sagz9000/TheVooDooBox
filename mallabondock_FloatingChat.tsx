...
import { mallabApi } from './mallabApi';
...
export default function FloatingChat({ activeTaskId, pageContext }: { activeTaskId?: string | null, pageContext?: string }) {
    ...
    const [messages, setMessages] = useState<{ role: 'user' | 'assistant', content: string }[]>([
        { role: 'assistant', content: 'Hello! I am your Mallab Analyst Assistant. I can investigate samples, query the knowledge base, and help you inspect telemetry.' }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            const data = await mallabApi.chat(
                userMsg.content,
