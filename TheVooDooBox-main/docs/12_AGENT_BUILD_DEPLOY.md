...
cd C:\AntiCode\TheVooDooBox\agent-windows
...
### Build Steps
```bash
cd /mnt/c/AntiCode/TheVooDooBox/agent-windows
...
- **Full Deployment Guide**: `docs/AGENT_DEPLOYMENT.md`
- **Build Script**: `scripts/build_agent.ps1`
- **Install Script**: `scripts/install_agent.ps1`
